...
def Info():
    ...
    #icon_image
    icon_image=PhotoImage(file=r"image\info.png")
    ...
    Label(Icon_window,text="tresbps - resting blood pressure (in mm Hg on admission to the hospital)",font="arial 11").place(x=20,y=190)
    Label(Icon_window,text="chol - serum cholestrol in mg/dI",font="arial 11").place(x=20,y=220)
    Label(Icon_window,text="fbs - fasting blood sugar > 120 mg/dI (1 = true; 0 = false)",font="arial 11").place(x=20,y=250)
    Label(Icon_window,text="restecg - resting electrocardiacgraphic results (0 = normal; 1 = having ST-T; 2 = hypertrophy",font="arial 11").place(x=20,y=280)
    Label(Icon_window,text="thalach - maximum heart rate achieved",font="arial 11").place(x=20,y=310)
    Label(Icon_window,text="exang - excercise induced angina (1 = yes; 0 = no)",font="arial 11").place(x=20,y=340)
    Label(Icon_window,text="oldpeak - ST depression induced by excercise relative to rest",font="arial 11").place(x=20,y=370)
    Label(Icon_window,text="slope - the slope of the peak excercise ST segment (0 = upsloping; 1 = flat; 2 = downsloping)",font="arial 11").place(x=20,y=400)
...
def Save():
    ...
    try:
        ...
        messagebox.showerror("Mission Data","please select restcgl!")
    ...
    try:
        ...
        messagebox.showerror("Mission Data","please select cal!")
    try:
...
Label(Heading_entry,image=Entry_image,bg="#df2f4b").place(x=20,y=30)
Label(Heading_entry,image=Entry_image,bg="#df2f4b").place(x=430,y=30)
Label(Heading_entry,image=Entry_image2,bg="#df2f4b").place(x=20,y=120)
Label(Heading_entry,image=Entry_image2,bg="#df2f4b").place(x=430,y=120)
